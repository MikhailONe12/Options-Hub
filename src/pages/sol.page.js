...
export const solPage = {
  ...
  tab: 'crypto',
  tickers: ['SOLUSDT'],
  dataSource: solDataSource,
  grid: { columns: 12, rowHeight: 160 },
  layout: [
    { block: 'priceComparison', col: 1, colSpan: 12, row: 1, rowSpan: 2, props: { startLabel: { fontSize: 13 }, labelA: 'Spot', labelB: 'Futures', leftMain: 'SOL' } },
    { block: 'pcRatio', col: 1, colSpan: 3, row: 3, rowSpan: 2, props: { title: 'SOL P/C RATIO', callKey: 'callOi', putKey: 'putOi' } },
