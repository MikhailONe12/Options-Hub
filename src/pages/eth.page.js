...
export const ethPage = {
  ...
  tab: 'crypto',
  tickers: ['ETHUSDT'],
  dataSource: ethDataSource,
  grid: { columns: 12, rowHeight: 160 },
  layout: [
    { block: 'priceComparison', col: 1, colSpan: 12, row: 1, rowSpan: 2, props: { startLabel: { fontSize: 13 }, labelA: 'Spot', labelB: 'Futures', leftMain: 'ETH' } },
    { block: 'pcRatio', col: 1, colSpan: 3, row: 3, rowSpan: 2, props: { title: 'ETH P/C RATIO', callKey: 'callOi', putKey: 'putOi' } },
