...
export const mntPage = {
  id: 'mnt',
  tab: 'crypto',
  tickers: ['MNTUSDT'],
  dataSource: mntDataSource,
  grid: { columns: 12, rowHeight: 160 },
  layout: [
    { block: 'priceComparison', col: 1, colSpan: 12, row: 1, rowSpan: 2, props: { startLabel: { fontSize: 13 }, labelA: 'Spot', labelB: 'Futures', leftMain: 'MNT' } },
    { block: 'pcRatio', col: 1, colSpan: 3, row: 3, rowSpan: 2, props: { title: 'MNT P/C RATIO', callKey: 'callOi', putKey: 'putOi' } },
